...
# Making STATIC_URL and MEDIA_URL Dynamic
...
STATICFILES_DIRS = [BASE_DIR / 'ecommerce_project' / 'static']
...
SESSION_COOKIE_AGE = 1209600  # Two weeks (optional)
SESSION_EXPIRE_AT_BROWSER_CLOSE = False
SESSION_COOKIE_SECURE = False  # Change to True in production
SESSION_SAVE_EVERY_REQUEST = True  # Ensures session updates
