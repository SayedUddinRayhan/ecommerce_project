...
class OrderItem(models.Model):
    ...
    def __str__(self):
        variation_details = ", ".join([f"{v.variation_category}: {v.variation_value}" for v in self.variations.all()])
        return f"{self.quantity} x {self.product.product_name} ({variation_details})"
